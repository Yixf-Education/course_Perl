...
\jiaoshi{伊现富}
\zhicheng{讲师}
\riqi{2019年10月16\&18日10:00-11:40\&13:30-15:10}
...
\begin{itemize}
  ...
  \item （20'）散列：介绍散列数据类型，讲解散列的初始化和常见操作等基本应用。
  \item （20'）数据结构和算法：介绍数据结构和算法之间的关系，通过实例分析数据结构和算法的选择，总结比较和排序的方法，介绍数据库和关系数据库的基本概念及其在Perl语言中的使用方法。
  ...
  \item （25'）阅读框：介绍开放阅读框及阅读框的基本概念，通过Perl程序讲解实现六种阅读框翻译的具体方法。
...
\begin{enumerate}
  ...
  \item \textcolor{red}{【重点、难点】}散列（20分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=0.43\textwidth]{c8_code_hash_01.png}}
...
\parpic[fr]{\includegraphics[width=0.4\textwidth]{c8_code_translation_01.jpg}}
      \item 知识点
	\begin{itemize}
  ...
  \item 读取FASTA文件（60分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=0.38\textwidth]{c8_code_orf_01.jpg}}
