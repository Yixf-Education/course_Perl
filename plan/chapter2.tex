...
\begin{itemize}
  ...
  \item （15'）Perl简介：介绍Perl的基本知识——特性、应用领域、版本、安装与学习等，通过实例介绍Perl的基本语法。
  ...
  \item （15'）判断语句：通过实例讲解if、unless、和given-when等条件语句。
...
\begin{enumerate}
  ...
  \item Perl简介（15分钟）
    \begin{enumerate}
      ...
      \item 优缺点
	\begin{itemize}
\parpic[fr]{\includegraphics[width=0.15\textwidth]{c2.perl.logo.01.jpg}}
	...
	\end{itemize}
\parpic[fr]{\includegraphics[width=0.15\textwidth]{c2.perl.logo.02.png}}
      \item 安装
%\parpic[fr]{\includegraphics[width=0.15\textwidth]{c2.perl.logo.03.jpg}}
	\begin{itemize}
