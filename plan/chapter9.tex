...
\jiaoshi{伊现富}
\zhicheng{讲师}
\riqi{2015年10/11月30/2日8:00-10:00}
...
\begin{itemize}
  ...
  \item （100'）限制酶切图谱：简单介绍限制酶的背景知识，通过制作酶切图谱的Perl程序详细讲解正则表达式在限制酶切位点分析中的应用。
...
\begin{enumerate}
  ...
  \item 正则表达式（80分钟）
	...
	\begin{itemize}
\parpic[fr]{\includegraphics[width=0.38\textwidth]{c9.enzyme.re.text.01.png}}
...
\parpic[fr]{\includegraphics[width=0.38\textwidth]{c9.enzyme.re.base.01.png}}
		...
		\begin{itemize}
		  ...
		  \item 元字符优先级
		    \vspace{-1em}
		    \begin{figure}[h]
		        \includegraphics[width=0.6\textwidth,height=6.1cm]{c9.enzyme.re.meta.01.png}
		        \includegraphics[width=0.4\textwidth]{c9.enzyme.re.meta.06.png}
		    \end{figure}
		    \vspace{-1em}
		\end{itemize}
	    \end{itemize}
...
\otherHeader
  ...
  \item 限制酶切图谱（100分钟）
    \begin{enumerate}
      \item 限制酶
	\begin{itemize}
\parpic[fr]{\includegraphics[width=0.5\textwidth]{c9.enzyme.eh.01.png}}
