...
\begin{enumerate}
  \item 引言与导入（15分钟）
	...
	\begin{enumerate}
	  \item 简介
	    \begin{itemize}
\parpic[fr]{\includegraphics[width=0.45\textwidth]{c7.mutation.point.01.png}}
...
\otherHeader
  ...
  \item 分析DNA（90分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=0.45\textwidth]{c7.mutation.nested.loop.png}}
