...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{c6_sub_kenan_01.jpg}
    \includegraphics[width=0.25\textwidth]{c6_sub_kebi_01.jpg}
    \includegraphics[width=0.37\textwidth]{c6_sub_yongzheng_01.jpg}
  \end{figure}
\end{frame}
