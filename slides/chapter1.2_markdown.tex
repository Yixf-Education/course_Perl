...
\subsection{多合一}
\begin{frame}
  \frametitle{格式转换 | 多合一 | FF Multi Converter}
...
\begin{frame}
  \frametitle{格式转换 | 多合一 | 在线工具 | Convertio}
  \begin{center}
    \href{https://convertio.co/zh/}{Convertio}
  \end{center}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c1_markdown_convertio.png}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{格式转换 | 多合一 | 在线工具 | ONLINE-CONVERT}
  \begin{center}
    \href{https://www.online-convert.com/}{ONLINE-CONVERT}
  \end{center}
  \begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{c1_markdown_convert.png}
  \end{figure}
\end{frame}

\begin{frame}
  \frametitle{格式转换 | 多合一 | 在线工具 | PDF转Word}
  \begin{center}
    \href{https://www.pdfwordconvert.com/zh/}{PDF-Word Converter}
  \end{center}
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c1_markdown_pdf2word.png}
  \end{figure}
\end{frame}
