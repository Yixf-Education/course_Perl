...
ImageMagick为很多程序语言提供了API库。在Perl语言中，ImageMagick的API叫做PerlMagick。\\
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c1.im.png}
  \end{figure}
\end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{block}{\textcolor{red}{convert}}
...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{c1.im.label.png}\qquad
  \includegraphics[width=0.3\textwidth]{c1.im.button.png}
\end{figure}
\end{frame}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{c1.im.cylinder.png}
\end{figure}
\end{frame}
