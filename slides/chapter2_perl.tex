...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=4cm]{c2_perl_logo_01.jpg}
    \hspace{1cm}
    \includegraphics[width=4cm]{c2_perl_logo_02.png}
    \vspace{0.5cm}
    \includegraphics[width=6cm]{c2_perl_logo_03.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c2_perl_japh_04.png}
    \quad
    \includegraphics[width=0.4\textwidth]{c2_perl_japh_05.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=0.9\textwidth]{c2_perl_metacpan_01.png}
  \end{figure}
\end{center}
\end{frame}
