...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9.5cm,height=7.5cm]{c1_intro_aa_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    % \centering
    \includegraphics[width=6cm]{c1_intro_db_02.png}
    \includegraphics[width=6.2cm]{c1_intro_db_05.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{c1_intro_language_rank_2016.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{c1_intro_language_rate_2016.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c1_intro_language_rate_period_2016.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{c1_intro_language_rate_history_2016.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \includegraphics[height=3.8cm]{c1_book_r_rgc.jpg}
  \end{figure}
\end{frame}
