...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{c3_programming_21days.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.48\textwidth]{c3_programming_version_05.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{编程艺术 | 编写真言}
  \begin{block}{重剑无锋，大巧不工}
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c3_programming_vs.jpg}
  \end{figure}
  \begin{center}
  \textcolor{red}{找到最合适的办法解决问题，而不是总用技术含量最高的方法！}
  \end{center}
  \end{block}
\end{frame}
